...
class __TwigTemplate_58d5761a4efe1a9a8a7af9a6666d4c179904c5611e9e632ea8461e8faa4c2e54 extends Twig_Template
{
    ...
    <span class=\"topBarElem\">
        ...
        if (($this->getContext($context, "userLogin") != "anonymous")) {
            // line 40
            echo "                ";
            if (((array_key_exists("isAdminLayout", $context) && ($this->getContext($context, "currentModule") == "UsersManager")) && ($this->getContext($context, "currentAction") == "userSettings"))) {
                // line 41
        ...
        foreach ($context['_seq'] as $context["lev1UserLabel"] => $context["lev1UserMenu"]) {
            if ((twig_slice($this->env, $this->getContext($context, "lev1UserLabel"), 0, 1) != "_")) {
                // line 48
                echo "
                ";
                // line 49
                if ((($this->getContext($context, "userLogin") != "anonymous") || (!$this->getAttribute($this->getContext($context, "loop"), "first")))) {
                    // line 50
                ...
                ";
                // line 53
                if (($this->getAttribute($this->getContext($context, "lev1UserMenu", true), "_hasSubmenu", array(), "any", true, true) && $this->getAttribute($this->getContext($context, "lev1UserMenu"), "_hasSubmenu"))) {
                    // line 54
                    echo "                    ";
                    if ($this->getContext($context, "lev1UserLabel")) {
                        // line 55
                        echo "                        <a class=\"item disabled category\">";
                        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array($this->getContext($context, "lev1UserLabel"))), "html", null, true);
                        echo "</a>
                    ";
                    }
                    // line 57
                    ...
                    // line 58
                    $context['_parent'] = (array) $context;
                    $context['_seq'] = twig_ensure_traversable($this->getContext($context, "lev1UserMenu"));
                    foreach ($context['_seq'] as $context["lev2Label"] => $context["lev2Menu"]) {
                        if ((twig_slice($this->env, $this->getContext($context, "lev2Label"), 0, 1) != "_")) {
                            // line 59
                            echo "                        ";
                            echo $this->getAttribute($this, "userMenuItem", array(0 => $this->getContext($context, "lev2Label"), 1 => $this->getContext($context, "lev2Menu"), 2 => $this->getContext($context, "currentModule"), 3 => $this->getContext($context, "currentAction")), "method");
                            echo "
                    ";
                        }
                    }
                    ...
                    // line 62
                    echo "                    ";
                    echo $this->getAttribute($this, "userMenuItem", array(0 => $this->getContext($context, "lev1UserLabel"), 1 => $this->getContext($context, "lev1UserMenu"), 2 => $this->getContext($context, "currentModule"), 3 => $this->getContext($context, "currentAction")), "method");
                    echo "
                ";
                }
                // line 64
...
";
    ...
    public function getuserMenuItem($_label = null, $_menu = null, $_currentModule = null, $_currentAction = null)
    {
        ...
        <a class=\"item ";
            // line 25
            if ((($this->getAttribute($this->getAttribute($this->getContext($context, "menu"), "_url"), "module") == $this->getContext($context, "currentModule")) && (twig_test_empty($this->getAttribute($this->getAttribute($this->getContext($context, "menu"), "_url"), "action")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "menu"), "_url"), "action") == $this->getContext($context, "currentAction"))))) {
                echo "active";
            }
            echo "\"
           href=\"index.php";
           ...
           id=\"usermenu-";
            ...
            echo twig_escape_filter($this->env, twig_lower_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "menu"), "_url"), "module")), "html", null, true);
            echo "-";
            echo twig_escape_filter($this->env, twig_lower_filter($this->env, (($this->getAttribute($this->getAttribute($this->getContext($context, "menu", true), "_url", array(), "any", false, true), "action", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getContext($context, "menu", true), "_url", array(), "any", false, true), "action"), "index")) : ("index"))), "html", null, true);
            echo "\"
           ";
            // line 28
            if ($this->getAttribute($this->getContext($context, "menu", true), "_tooltip", array(), "any", true, true)) {
