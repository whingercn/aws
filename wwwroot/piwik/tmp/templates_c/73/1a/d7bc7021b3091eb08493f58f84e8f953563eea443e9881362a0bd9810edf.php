...
class __TwigTemplate_731ad7bc7021b3091eb08493f58f84e8f953563eea443e9881362a0bd9810edf extends Twig_Template
{
    ...
    <div class=\"mapWidgetStatus\">
        ";
        // line 21
        if ($this->getContext($context, "noData")) {
            // line 22
    ...
    <div class=\"dataTableFeatures\" style=\"padding-top:0;\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["metric"]) {
            // line 59
            echo "                    <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "metric"), 0, array(), "array"), "html", null, true);
            echo "\" ";
            if (($this->getAttribute($this->getContext($context, "metric"), 0, array(), "array") == $this->getContext($context, "defaultMetric"))) {
                echo "selected=\"selected\"";
            }
            echo "}>";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "metric"), 1, array(), "array"), "html", null, true);
            echo "</option>
                ";
        }
...
<script type=\"text/javascript\">
    ...
    config = JSON.parse('";
            // line 81
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getContext($context, "config"), "js"), "html", null, true);
            echo "');
    config._ = JSON.parse('";
            // line 82
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getContext($context, "localeJSON"), "js"), "html", null, true);
            echo "');
    config.reqParams = JSON.parse('";
            // line 83
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getContext($context, "reqParamsJSON"), "js"), "html", null, true);
            echo "');
