...
class __TwigTemplate_c397bd90407c1bf0a020c7149c538d5068626c864698fd01d777680aaa73369c extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dateCountPair"]) {
            // line 3
            echo "        ";
            $context["date"] = $this->getAttribute($this->getContext($context, "dateCountPair"), 0, array(), "array");
            // line 4
            echo "        ";
            $context["counts"] = $this->getAttribute($this->getContext($context, "dateCountPair"), 1, array(), "array");
            // line 5
            echo "        <span data-date=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "date"), "html", null, true);
            echo "\" data-count=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "counts"), "count"), "html", null, true);
            echo "\" data-starred=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "counts"), "starred"), "html", null, true);
            echo "\"
              ";
            // line 6
            if (($this->getAttribute($this->getContext($context, "counts"), "count") == 0)) {
                echo "title=\"";
                ...
                echo "\"
              ";
            } elseif (($this->getAttribute($this->getContext($context, "counts"), "count") == 1)) {
                // line 7
                echo "title=\"";
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Annotations_AnnotationOnDate", $this->getContext($context, "date"), $this->getAttribute($this->getContext($context, "counts"), "note")));
                // line 8
                echo "
";
                // line 9
            ...
            // line 11
            if (($this->getAttribute($this->getContext($context, "counts"), "starred") > 0)) {
